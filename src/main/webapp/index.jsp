...
<div class="contenaire-global">
        ...
        <div id="container1" class="container1">
            ...
            <form class="simuler-mon-credit" action="${pageContext.request.contextPath}/storeForm1" method="post">
                ...
                <div class="mensualite-group">
                    ...
                    <input class="input3 " type="number" id="mensualite" step="0.01" name="mensualite" value="1580"><br>
    ...
    <div class="recap">
        ...
        <div id="infos-personnelles" class="infos-personnelles" style="display: none">
