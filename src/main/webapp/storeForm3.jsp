...
<div class="contenaire-global">
        ...
        <div id="container3" class="container3">
            ...
            <form class="mes-infos-personnelles" action="${pageContext.request.contextPath}/submitForm" method="post">
                ...
                <div class="div-mes-infos-personnelles">
                    ...
                    <div class="input-radio-civilite">
                ...
                <div class="input-radio2">
                    ...
                    <div>Avez-vous des crédits en cours ?</div>
                ...
                <div style="padding-right: 60px; padding-left: 60px; padding-top: 20px;">
                    ...
                    <label style="font-size: 14px;" for="accept-terms">J'ai lu et j'accepte les conditions générales
                        d'utilisation figurant sur les informations légales, notamment la mention relative à la
                ...
                <div class="footer">
                    <p>Simulation à titre indicatif et non contractuelle. La mensualité minimale est de 180 dirhams. Un
                        client Wafasalaf peut bénéficier d'une tarification plus avantageuse en fonction de ses
    ...
    <div class="recap">
        ...
        <div id="infos-personnelles" class="infos-personnelles">
            <p style="background-color:#F1F2F6; font-size: 16px; color:#30435c; width: 100%; padding:10px;">Coordonnées
                et infos personnelles</p>
            <p>Email:</p>
            <p>Telephone:</p>
        </div>
